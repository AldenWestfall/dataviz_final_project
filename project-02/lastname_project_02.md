...
<img src="lastname_project_02_files/figure-html/unnamed-chunk-3-1.png" title="A revamped map of the U.S. showcasing the NBA Final Championship Wins by City. Each city is represented by a dot on the map that is scaled with the number of wins along with a more clear label." alt="A revamped map of the U.S. showcasing the NBA Final Championship Wins by City. Each city is represented by a dot on the map that is scaled with the number of wins along with a more clear label."  />
...
![](lastname_project_02_files/figure-html/fig-1.png)<!-- -->
